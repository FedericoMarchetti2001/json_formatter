# FEATURES AND FIXES
FEAT: Add achievements section and special unlockable girl images
FEAT: Gamify the quote section with a "Would say" - "Would not say" button for what a goth/emo girl would say. This can be connected to achievements
FEAT: 
